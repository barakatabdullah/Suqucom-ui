...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'AdminDashboard': RouteRecordInfo<'AdminDashboard', '/s-admin', Record<never, never>, Record<never, never>>,
    'Admins': RouteRecordInfo<'Admins', '/s-admin/admins', Record<never, never>, Record<never, never>>,
    'Admins-id': RouteRecordInfo<'Admins-id', '/s-admin/admins/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'Admins-add': RouteRecordInfo<'Admins-add', '/s-admin/admins/add', Record<never, never>, Record<never, never>>,
    ...
    'AdminLogin': RouteRecordInfo<'AdminLogin', '/s-admin/login', Record<never, never>, Record<never, never>>,
    ...
    'Reports': RouteRecordInfo<'Reports', '/s-admin/reports', Record<never, never>, Record<never, never>>,
    'Products-reviews': RouteRecordInfo<'Products-reviews', '/s-admin/reviews/products', Record<never, never>, Record<never, never>>,
    ...
    'Orders': RouteRecordInfo<'Orders', '/s-admin/sales/orders', Record<never, never>, Record<never, never>>,
    'General-settings': RouteRecordInfo<'General-settings', '/s-admin/settings/general', Record<never, never>, Record<never, never>>,
