...
<template>
  <div class="w-full py-4 flex gap-6 justify-between">
    ...
    <div class="flex gap-4 items-center">
      ...
      <div
        @click="toggle"
        class="flex items-center gap-4 justify-between cursor-pointer min-w-12rem"
      >
        <div class="flex items-center gap-4">
          <Avatar
            :image="adminStore.admin.avatar ?? undefined"
            :icon="adminStore.admin.avatar == null ? 'i-hugeicons-user' : ''"
            class="bg-primary-100 border! dark:border-neutral-700!"
            size="large"
            shape="circle"
          />
          <div @click="" class="flex flex-col">
            <h1
              class="text-1.2rem font-semibold text-primary-700 dark:text-primary-300"
            >
        ...
        <i
          class="i-hugeicons-arrow-down-01 text-primary-700 dark:text-primary-300"
        ></i>
      </div>
