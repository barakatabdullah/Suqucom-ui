...
const mode = ref<"view" | "edit">(
  (route.query.mode as "view" | "edit") ?? "view",
);
...
const AdminSchema = toTypedSchema(
  zod.object({
    name: zod.string().min(2, {
      message:
        t("validation.name_min_length") || "Name must be at least 2 characters",
    }),
    email: zod.string().email({
      message: t("validation.email_invalid") || "Invalid email address",
    }),
    roles: zod.array(zod.number()).min(1, {
      message:
        t("validation.role_required") || "At least one role must be selected",
    }),
...
const { defineField, handleSubmit, errors, resetForm, setValues, values } =
  useForm({
...
const isFormDirty = computed(() => {
  ...
  return (
    ...
    values.password !== "" ||
    !areRolesEqual(
      (values.roles as number[]) || [],
      adminData.value.roles.map((r: { id: number }) => r.id),
    ) ||
...
const adminDesc = computed(
  () => t("admin.description") || "Manage admin details",
);
</script>
  ...
  >
    ...
    <div class="w-full flex items-center justify-between mb-4">
      <div class="flex flex-col gap-2 items-start">
        <div class="flex items-center gap-2">
          ...
          <h2 class="font-600 text-6 text-color uppercase">
            {{ mode === "view" ? viewText : editText }}
            {{ $t("admin.singular") || "Admin" }}
          </h2>
        </div>
      ...
      <div class="flex gap-2">
        <Button
          @click="toggleMode"
          :label="mode === 'view' ? editText : viewText"
    ...
    <!-- Loading state -->
    <div
      v-if="isLoadingAdmin || isLoadingRoles"
    ...
    >
            ...
            <div v-else class="flex flex-col items-center">
              ...
              <FileUpload
                ...
                :pt="{
                  container: {
                    class:
                      'w-full border-2 border-dashed border-gray-300 dark:border-neutral-700 rounded-lg p-6 text-center',
                  },
                }"
              >
                ...
                <template #empty>
                  <div class="flex flex-col items-center p-6">
                    ...
                    >
                      <i
                        class="i-hugeicons-image-upload text-4xl text-muted-color"
                      />
                    </div>
                    <p class="mt-6 mb-0">
          ...
          <div v-if="mode === 'view'" class="p-5">
            ...
            <div class="space-y-3">
              ...
              <div class="flex items-center justify-between">
                ...
                <Tag
                  :severity="adminData.active ? 'success' : 'danger'"
                  :value="
                    adminData.active
                      ? $t('active') || 'Active'
                      : $t('inactive') || 'Inactive'
      ...
      <div class="col-span-12 lg:col-span-8">
        ...
        >
          <!-- Details header -->
          <div
            class="bg-gray-50 dark:bg-neutral-800 p-5 border-b border-neutral-200 dark:border-neutral-700"
          >
            ...
            <div v-else class="space-y-6">
              ...
              <div class="flex items-center gap-2">
                <label class="font-medium">{{
                  $t("account_active") || "Account Active"
                }}</label>
