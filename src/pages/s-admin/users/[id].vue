...
const UserSchema = toTypedSchema(
  zod.object({
    fname: zod.string().min(2, {
      message:
        t("validation.fname_min_length") ||
        "First name must be at least 2 characters",
    }),
    lname: zod.string().min(2, {
      message:
        t("validation.lname_min_length") ||
...
onBeforeRouteLeave((to, from, next) => {
  if (mode.value === "edit" && isFormDirty.value) {
    confirm.require({
      group: "back",
      message:
        t("confirmations.unsaved_changes") ||
    ...
    <div v-if="isLoadingUser" class="flex justify-center items-center py-16">
      <div class="flex flex-col items-center">
        ...
        <p class="mt-4 text-gray-600">
          {{ $t("loading_user") || "Loading user information..." }}
        </p>
      </div>
    </div>
    ...
    >
      ...
      >
        ...
        <h3 class="text-xl font-semibold mb-2">
          {{ $t("errors.failed_to_load_user_data") }}
        </h3>
          ...
          <div class="p-5">
            ...
            <div v-if="mode === 'view'" class="space-y-6">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <!-- Email -->
                <div
                  class="p-4 bg-gray-50 dark:bg-neutral-800 rounded-lg col-span-2"
                >
                  <div class="text-sm text-gray-500 mb-1">
                    {{ $t("email") || "Email" }}
                  </div>
