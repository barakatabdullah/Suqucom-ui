...
<template>
  ...
  >
    ...
    <div
      class="max-w-30rem rounded-5 w-full bg-white border dark:border-neutral-800 dark:bg-primary-900 py-12 px-6"
    >
      <form @submit="onSubmit" class="w-full px-4">
        <div class="flex flex-col gap-6">
          <h1
            class="text-3xl text-center font-bold text-primary-700 dark:text-primary-300"
          >
            {{ $t("login") }}
          </h1>
          ...
          <div class="flex flex-col gap-2">
            <label
              class="text-primary-500 text-3.5 font-semibold"
              for="email"
              >{{ $t("email") }}</label
            >
            <InputText
          ...
          <div class="flex flex-col gap-2">
            <label
              class="font-semibold text-primary-500 text-3.5"
              for="password"
              >{{ $t("password") }}</label
            >
            <Password
