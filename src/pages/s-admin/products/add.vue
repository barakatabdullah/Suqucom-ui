    ...
    <div class="border rounded-6 w-full h-full p-9 flex flex-col gap-6">
        ...
        <div class="w-full flex items-center justify-between">
            <div class="flex flex-col gap-2 items-start">
                <h2 class="font-600 text-6 text-color">Add Product</h2>
                <p class="text-gray-600">You can Add a new Product</p>
            </div>
        </div>
        <form class="w-full h-full flex flex-col gap-6 overflow-hidden">
            ...
            <div class="grid grid-cols-2 gap-6">
                ...
                <div class="flex flex-col gap-1 col-span-2">
                    ...
                    <FileUpload ref="fileupload" name="demo[]" accept="image/*" :maxFileSize="1000000" customUpload
